...
setwd("C:/Users/pavankumar pendela/Desktop/R/ppendela-74790/ppendela-74790/assignment 4")
```
...
colSums(is.na(pharma)) ## returns the number of null values in each column
```
...
pharma_NUMERIC_VALUES <- pharma[,c(3:11)]
```

```{r}
# Scaling quantitative variables in the data frame (z-score)

DATA<- as.data.frame(scale(pharma_NUMERIC_VALUES))
